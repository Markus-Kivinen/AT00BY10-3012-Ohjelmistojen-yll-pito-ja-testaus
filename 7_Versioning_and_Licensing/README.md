...
Joskus kun on aikaa, siirryn käyttämään matriiseja kameran sijainnin ja suunnan määrittämiseen, mikä luultavasti tarkoittaa siirtymistä versioon 2.0.0
...
Todellisuudessa ensimmäistä numeroa saatetaan kasvattaa myös silloin, jos uusi ominaisuus on merkittävä ja vaatii paljon työtä, vaikka se ei rikkoisi taaksepäin yhteensopivuutta.
